...
export class Employee extends Component{
    ...
    deleteClick(id){
        if(window.confirm('Are you sure?')){
            this.fetchDataWithAuthentication(variables.API_URL+'employee/'+id,{
            method:'DELETE',
            headers:{
                'Accept':'application/json',
                'Content-Type':'application/json'
    ...
    imageUpload=(e)=>{
        ...
        this.fetchDataWithAuthentication(variables.API_URL+'employee/savefile',{
            method:'POST',
            body:formData
        })
        .then(res=>res.json())
   ...
   <div className="modal-body">
    <div className="d-flex flex-row bd-highlight mb-3">
     ...
     <div className="p-2 w-50 bd-highlight">
         ...
         src={PhotoPath+PhotoFileName} alt='user pic'/>
