...
export class Department extends Component{
    ...
    changeDepartmentIdFilter = (e)=>{
        this.setStatetate.DepartmentIdFilter=e.target.value;
        this.FilterFn();
    }
    changeDepartmentNameFilter = (e)=>{
        this.setStatetate.DepartmentNameFilter=e.target.value;
        this.FilterFn();
    }
    ...
    deleteClick(id){
        if(window.confirm('Are you sure?')){
            this.fetchDataWithAuthentication(variables.API_URL+'department/'+id,{
            method:'DELETE',
            headers:{
                'Accept':'application/json',
                'Content-Type':'application/json'
